...
The goals of uniform are the unification of a differently or incompletely reported continuous outcome across studies included in a meta-analysis and calculation of consistent effect measures so that they can be pooled. Currently, uniform comprises the following functions:
